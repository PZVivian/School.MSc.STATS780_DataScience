...
## STEP 1: CREATE 2-DIGIT NAICS LOOKUP DATA ##
# Pull 2-digit NAICS codes and their descriptions from the source website. If code ranges exist, then keep it is as is
# (ex. "31-33" for Manufacturing).
...
# Expand rows that have code ranges vertically so that each row only contains one code
naicsCodes <- rbind(naicsCodes, codeRangesOnly) %>% filter(str_length(`Sector Code (2-digit NAICS Code)`)==2)


## STEP 2: FILTER DISPOSAL DATA FOR ASBESTOS AND JOIN 2-DIGIT NAICS LOOKUP DATA ##
...
###Figure 1: XYZ - Code ###Figure 2: XYZ - Code ###Figure 3: XYZ - Code

\newpage

## References

Go through bookmarks bar
