...
chooseK <- function(k, silFun, data) {
  ...
  text(x=sil_max_k, y=sil_max, pos=1, col="red",
     labels= c(paste0("Max: (",sil_max_k,", ",round(sil_max,2), ")")))
}

#plotSil(kmcSilK(2, absentData_sd)) # k-means clustering
#plotSil(hcSilK(2, absentData_sd)) # hierarchical clustering
#plotSil(hcSilK(2, pr_out$x[, 1:2])) # hierarchical clustering after PCA
#chooseK(2:30, kmcSilK, absentData_sd)
